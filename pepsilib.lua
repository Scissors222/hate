local library = {
	...
	colors = {
		...
		outerBorder = Color3.fromRGB(143,143,143),
		innerBorder = Color3.fromRGB(253, 253, 253),
		topGradient = Color3.fromRGB(255,255,255),
		bottomGradient = Color3.fromRGB(107, 107, 107),
